#ifndef GHOST_SCHEDULERS_LOTTERY_ORCHESTRATOR_H
#define GHOST_SCHEDULERS_LOTTERY_ORCHESTRATOR_H
...
namespace ghost
{
    ...
    public:
        ...
        inline uint64_t GetDeadline() const
        {
            return deadline_;
        }
...
#endif // GHOST_SCHEDULERS_LOTTERY_ORCHESTRATOR_H